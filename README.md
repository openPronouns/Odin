...
## Support us
Normally, I'd be plugging donation links here but the project is nowhere near the stage for that yet. If you'd like to support the project, feel free to contribute to the codebase. Got a suggestion? Let me know on [Gitter](https://gitter.im/openPronouns/community) or [Matrix](https://matrix.to/#/#openPronouns_community:gitter.im) (both are bridged to the other). Security issue? Message me directly on [Matrix](https://matrix.to/#/@Ludoviko_:matrix.org) or [email](mailto:me@ludoviko.ch) me.